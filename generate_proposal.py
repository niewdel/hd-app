...
def bid_table(items, st):
    ...
    # Row heights ÃÂ¢ÃÂÃÂ banner auto-sizes (matches Project Notes header), col header fixed
    col_hdr_h = 0.28 * inch
...
def total_line(total):
    """CO-style contract total ÃÂ¢ÃÂÃÂ bold label + amount on gray background
...
def approval_page(data, st):
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Section header ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    elems.append(red_hdr('Client Approval & Authorization', st, cw))
    elems.append(Spacer(1, 0.14*inch))

    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Project summary box ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Approved contract value (print-friendly ÃÂ¢ÃÂÃÂ matches contract total style) ÃÂ¢ÃÂÃÂ
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Authorization language ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Bilateral signature block ÃÂ¢ÃÂÃÂ CO style ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
    ...
    # ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Paving Overage Unit Prices ÃÂ¢ÃÂÃÂ Option C (bid-table style) ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
def tc_block(title, body_items, st, cw):
    ...
    for item in body_items:
        if item.startswith('ÃÂ¢ÃÂÃÂ¢'):
...
def tc_pages(st):
    ...
    sections = [
        ...
        ('5. Site Access & Staging', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ Delays, re-mobilizations, or standby time caused by restricted access, site conflicts with other trades, or unavailability of the work area will be billed at the applicable unit rates in the Paving Overage Unit Prices.',
            'ÃÂ¢ÃÂÃÂ¢ Customer is responsible for ensuring underground utilities are located and marked prior to the start of work. HD Hauling & Grading is not liable for damage to unmarked utilities.',
        ]),
        ('6. Subgrade Acceptance & Pavement Performance', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ Prior to paving, the Customer or their designated representative is responsible for ensuring the subgrade and base course have been properly graded, compacted to NCDOT specifications, proof-rolled where required, and inspected. Commencement of paving constitutes Customer\'s acceptance of subgrade conditions.',
            'ÃÂ¢ÃÂÃÂ¢ Proof rolling, moisture content testing, and base course density testing are the responsibility of the Customer unless explicitly included in the scope of work.',
            'ÃÂ¢ÃÂÃÂ¢ If HD Hauling & Grading identifies conditions that may affect pavement performance, written notification will be provided. Customer\'s direction to proceed releases HD Hauling & Grading from performance liability related to those conditions.',
        ]),
        ('7. Materials & NCDOT Specifications', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ Material substitutions required due to plant availability or supply chain disruptions will be communicated promptly. Functionally equivalent materials will be substituted at no additional cost.',
            'ÃÂ¢ÃÂÃÂ¢ HD Hauling & Grading does not guarantee long-term availability of specific mix designs or material sources.',
        ]),
        ('8. Weather & Temperature Conditions ÃÂ¢ÃÂÃÂ Asphalt', [
            'Asphalt paving will not be performed under the following conditions: ambient or surface temperatures below 40ÃÂÃÂ°F and falling; during rain, sleet, or snow; when the base course contains standing water or frost; or when forecast conditions within four (4) hours are anticipated to compromise compaction or curing.',
            'ÃÂ¢ÃÂÃÂ¢ Schedule adjustments caused by weather are not grounds for price renegotiation, penalties, or liquidated damages against HD Hauling & Grading.',
        ]),
        ('9. Concrete Work Conditions', [
            'All concrete work shall be performed in accordance with applicable ACI standards and NCDOT specifications. Concrete will not be placed when ambient temperatures are below 40ÃÂÃÂ°F without approved cold-weather protection measures, or when temperatures exceed 90ÃÂÃÂ°F without appropriate hot-weather precautions.',
            'ÃÂ¢ÃÂÃÂ¢ Form layout, grade stakes, and joint locations must be approved by the Customer or their representative prior to placement. Once concrete is placed, corrections to layout or elevation are billable as additional work.',
            'ÃÂ¢ÃÂÃÂ¢ Cure time and form removal timing will be determined by HD Hauling & Grading based on ambient conditions and mix design requirements. Customer requests to accelerate form removal or trafficking of concrete prior to adequate cure are at Customer\'s sole risk.',
            'ÃÂ¢ÃÂÃÂ¢ HD Hauling & Grading is not responsible for surface defects, cracking, or scaling resulting from: improper curing practices by others, premature trafficking, freeze-thaw cycles, de-icing chemical application, or subgrade settlement outside HD Hauling & Grading\'s scope.',
        ]),
        ('10. Compaction & Quality', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ HD Hauling & Grading is not liable for compaction failures resulting from: mix temperature loss during transport caused by factors outside its control, Customer-caused delays between delivery and laydown, or subgrade instability.',
        ]),
        ('11. Warranty', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ Damage from petroleum products, chemical spills, or de-icing agents',
            'ÃÂ¢ÃÂÃÂ¢ Pavement failure from subgrade conditions not prepared by HD Hauling & Grading',
            'ÃÂ¢ÃÂÃÂ¢ Damage from vehicle loads exceeding pavement design capacity',
            'ÃÂ¢ÃÂÃÂ¢ Deterioration adjacent to a repaired area on maintenance projects',
            'ÃÂ¢ÃÂÃÂ¢ Pavement markings or signage not installed by HD Hauling & Grading',
            'ÃÂ¢ÃÂÃÂ¢ Normal wear, surface oxidation, and expected pavement aging',
            'ÃÂ¢ÃÂÃÂ¢ Damage from third parties, acts of God, or events beyond HD Hauling & Grading\'s control',
        ...
        ('12. Traffic Control & Permits', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ The Customer is responsible for all permits, right-of-way authorizations, and NCDOT lane closure approvals prior to the scheduled start of work.',
            'ÃÂ¢ÃÂÃÂ¢ ADA compliance determinations for pavement markings, curb ramps, and accessible routes are the responsibility of the Owner and Engineer of Record.',
        ]),
        ('13. Pavement Markings & Signage', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ Thermoplastic markings require a minimum asphalt cure period before application.',
            'ÃÂ¢ÃÂÃÂ¢ Signage installation will follow locations and specifications provided. Sign content, ADA designation, and regulatory compliance are the Customer\'s responsibility.',
        ]),
        ...
        ('17. Material Pricing & Availability', [
            ...
            'ÃÂ¢ÃÂÃÂ¢ HD Hauling & Grading is not liable for delays caused by plant shutdowns, material shortages, or supplier issues.',
        ]),
        ('18. Force Majeure', [
